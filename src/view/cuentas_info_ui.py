...
class Ui_cuentasInfoWindow(object):
    def setupUi(self, cuentasInfoWindow):
        ...
        cuentasInfoWindow.setWindowIcon(icon)
        cuentasInfoWindow.setStyleSheet(u"background-color: rgb(17, 51, 83);")
        ...
        self.table_more_info.setStyleSheet(u"background-color: rgb(39, 39, 39)")
