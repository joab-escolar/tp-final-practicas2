...
from PySide6.QtWidgets import (QApplication, QLabel, QLineEdit, QMainWindow,
    ...
    QWidget)
import images.login_resource_rc
...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.input_username.setGeometry(QRect(410, 340, 171, 31))
        self.input_username.setStyleSheet(u"color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);")
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(410, 320, 49, 16))
        self.btn_ingresar = QPushButton(self.centralwidget)
        self.btn_ingresar.setObjectName(u"btn_ingresar")
        self.btn_ingresar.setGeometry(QRect(410, 520, 171, 41))
        self.btn_ingresar.setStyleSheet(u"background-color: rgb(11, 3, 255);\n"
